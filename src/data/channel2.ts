export const episodes = [
    ...
    sjRQgTbbfwA 5:58 Genesis - Dance On A Volcano (Official Audio)
    LLKIKVOdW7c 6:28 Genesis - Entangled (Official Audio)
    mmPf1rGClzA 6:31 Squonk (2007 Remaster)
    UkVY3lJsBAA 7:36 Genesis - Mad Man Moon (Official Audio)
    6rfdi3HQBgs 6:19 Genesis - Robbery, Assault And Battery (Official Audio)
    7H1xV998xI0 8:06 Genesis - Ripples (Official Audio)
    8xQM94V0WyQ 4:36 Genesis - A Trick Of The Tail (Official Audio)
    EjFVJnrMqXI 5:53 Genesis - Los Endos (Official Audio)
    `,
    `
    # Genesis - Wind and Wuthering
    NxzcxqucCI4 7:45 Genesis - Eleventh Earl Of Mar (Official Audio)
    L1lYeAmcKWk 10:00 Genesis - One For The Vine (Official Audio)
    tZGDwLjwwes 6:18 Genesis - Your Own Special Way (Official Audio)
    n4PWOd1YmIM 3:21 Genesis - Wot Gorilla? (Official Audio)
    QS-SRUCmimg 6:40 Genesis - All In A Mouse's Night (Official Audio)
    a9SuH_6uWQU 5:28 Genesis - Blood On The Rooftops (Official Audio)
...
export const videos = `
    ...
    tax7ZlWyYvA 1:34:21 The Lamb Lies Down On Broadway Genesis Full Remastered Album 1974
`